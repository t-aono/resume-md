...
元々は正社員として勤務していましたが、新しい技術を実務で試すことができる点や、自律的に集中して取り組める点を魅力的に感じ、フリーランスに転向しました。

Next.jsやSvelteKitなどのフルスタックなWebアプリFWを活用した開発が得意で、要件整理・UI構築・API設計・DB設計など幅広く担当しています。少人数体制で裁量を持ちながら、新しい技術にも積極的に試せる環境を求めています。

## 経歴

<details open>
<summary>2022 ~ 現在：フロントエンド・バックエンドエンジニア @ フリーランスとして活動</summary>

概要

- サービス業・製造業・海事産業など多様な業界のWebアプリ開発に従事、実装・設計を主に担当
- 要件定義をもとに初期開発から機能追加・改善まで実装を担当し、技術選定にも携わる                          
- SSR・SPA・PWAなど要件に応じた適切な構成でWebアプリ開発を実施
- プロジェクトやチームの状況に応じて、出社・リモートや会議対応を含め柔軟に対応

使用技術

- TypeScript, Next.js, SvelteKit, Node.js, Angular, Vue.js, Laravel, Firebase, Google Cloud

</details>

<details>
<summary>2020 ~ 2022：フロントエンド・バックエンドエンジニア @ Webシステム受託開発会社に勤務</summary>

概要

- 代表と2名体制の少人数チームで、Webシステムの受託開発に従事
- 顧客へのヒアリングから設計、実装、テスト、運用まで一連のWeb開発業務を幅広く経験
- 副業として、フレームワークを用いたWebアプリ開発にリモートで従事

使用技術

- PHP, JavaScript, MySQL, jQuery, Laravel, Vue.js

</details>

<details>
<summary>2017 ~ 2020：テスター・プログラマー @ SESの会社に所属し複数のWebシステム開発現場を経験</summary>

概要

- テスト業務、バグ原因調査、ドキュメント整備を担当
- SIerの大規模な業務系システム保守・改善プロジェクトに参画
- 既存プログラムの部分的な改修やツール制作、システム品質向上をサポート
...
<details open>
<summary>1-1: 自治体職員向けポータルサイト</summary>

- 期間：2024/11 ~ 現在
- 契約形態：業務委託 / J 社（自治体職員向けメディアの運営、自治体活動支援など）
- チーム構成：フロントエンドエンジニア：1名、バックエンド・インフラエンジニア：2名
- 担当業務：フロント側の設計・実装、技術調査、検証
- 成果：フロント側の開発をリードし、目標期間内にWebアプリの構築を完了
...
- 担当業務：画面の設計・構築、API実装、DB設計、設計資料の作成・レビュー
- 成果：顧客からヒアリングした業務内容をシステムに反映し、使いやすさを向上
