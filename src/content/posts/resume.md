...
- PHP・JavaScript・MySQLを用いたWebシステム開発に従事し、代表と2名体制の少人数チームで開発
- クライアントへのヒアリングから設計、実装、テスト、運用まで一連のWeb開発業務を幅広く経験
- 受託開発として駐車場機器メーカーや保険代理店向けWebシステムを担当し、副業ではLaravel・Vue.jsを用いたWebアプリ開発にも従事

役割

- クライアントとの打ち合わせを行い、要件整理から設計・実装まで担当
- 新規サービスの開発、既存サービスの改善や新機能の追加を実施
...
- SIer の大規模業務系システム案件で保守・改善を担当

役割

- 既存プログラムの部分的な改修、システム品質向上をサポート
